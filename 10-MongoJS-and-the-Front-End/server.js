...
// Dependencies require statments
var express = require("express");
var mongojs = require("mongojs");

// Initialize Express constructor
var app = express();

// Set up a static folder (public) for our web app, everything in this folder will be here bc its static
app.use(express.static("public"));

// Database configuratio
// Save the URL of our database as well as the name of our collection, constructor function from mongo js
var databaseUrl = "zoo";
